...
public class BatteryTile extends QSTile<QSTile.State> implements BatteryController.BatteryStateChangeCallback {
    ...
    /*SPRD bug 618199:BatteryLevel show 0% at the first boot device{@*/
    private boolean isBatteryLevelChanged = false;
    /*@}*/
    ...
    protected void handleUpdateState(State state, Object arg) {
        ...
        if(!isBatteryLevelChanged){
            Log.d(TAG, "handleUpdateState isBatteryLevelChanged="+isBatteryLevelChanged);
            return;
            }
        /*@}*/
    ...
    public void onBatteryLevelChanged(int level, boolean pluggedIn, boolean charging) {
        /*SPRD bug 618199:BatteryLevel show 0% at the first boot of device{@*/
        isBatteryLevelChanged = true;
        /*@}*/
        mLevel = level;
