...
public class DndTile extends QSTile<QSTile.BooleanState> {
    ...
    public void handleClick() {
        ...
        if (mState.value) {
            ...
            /*SPRD bug 607200:Dndtile detail maybe dispear after handleclick{@*/
            showDetail(true);
            final int zen = Prefs.getInt(mContext, Prefs.Key.DND_FAVORITE_ZEN, Global.ZEN_MODE_ALARMS);
            Log.d(TAG, "handleClick zen="+zen+",mShowingDetail="+mShowingDetail);
            if(mShowingDetail){
