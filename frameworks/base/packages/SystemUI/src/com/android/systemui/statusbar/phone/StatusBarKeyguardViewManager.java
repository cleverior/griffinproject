...
public class StatusBarKeyguardViewManager implements RemoteInputController.Callback {
    ...
    /** Fix bug 515756 lock screen shaking to changed song  {@ **/
    private KeyguardMusicManager mKeyguardMusicManager;
    private boolean isLockMusicEnabledSetting;
    /** @} **/
    ...
    public void registerStatusBar(PhoneStatusBar phoneStatusBar,
        ...
        /** Fix bug 515756 lock screen shaking to changed song  {@ **/
        isLockMusicEnabledSetting = Settings.Global.getInt(mContext.getContentResolver(),
                Settings.Global.LOCK_MUSIC_SWITCH, 0) != 0;
        if(isLockMusicEnabledSetting && isLockMusicEnabledSetting){
    ...
    public void show(Bundle options) {
        ...
        reset();
        /** Fix bug 515756 lock screen shaking to changed song  {@ **/
        if(isLockMusicEnabledSetting && mKeyguardMusicManager != null){
