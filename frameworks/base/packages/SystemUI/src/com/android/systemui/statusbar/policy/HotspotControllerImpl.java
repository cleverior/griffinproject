...
public class HotspotControllerImpl implements HotspotController {
    ...
    //SPRD: Bug #632061 Add for BT Softap is not coexist   -->
    private static final int BLUETOOTH_OFF = 0;
    //<-- Add for BT Softap is not coexist END
     ...
     // Settings
        if (enabled) {
            ...
            if (!supportBtWifiSoftApCoexist) {
                ...
                //SPRD: Bug #632061 Add for BT Softap is not coexist   -->
                boolean isBluetoothPersistedStateOn = Settings.Global.getInt(mContext.getContentResolver(),
                Settings.Global.BLUETOOTH_ON, 0) != BLUETOOTH_OFF;
                if (mBar != null
                        && ((btState != BluetoothAdapter.STATE_OFF) || isBluetoothPersistedStateOn)) {
