...
public class NetworkControllerImpl extends BroadcastReceiver
    ...
    NetworkControllerImpl(Context context, ConnectivityManager connectivityManager,
        ...
        mCallbackHandler = TeleSystemUIFactory.getInstance().createCallbackHandler();
    ...
    public void addSignalCallback(SignalCallback cb) {
        ...
        for (MobileSignalController mobileSignalController : mMobileSignalControllers.values()) {
            ...
            mobileSignalController.refreshImsIcons();
        }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        } else if (action.equals(TelephonyIntentsEx.ACTION_HIGH_DEF_AUDIO_SUPPORT)) {
            boolean isHdVoiceSupport = intent.getBooleanExtra("isHdVoiceSupport", false);
            Log.d(TAG, "HIGH_DEF_AUDIO_SUPPORT = " + isHdVoiceSupport);
            mCallbackHandler.setMobileHdVoiceIndicators(isHdVoiceSupport,
                    SubscriptionManager.INVALID_SUBSCRIPTION_ID,
                    TelephonyIcons.ICON_HD_VOICE);
        } else {
