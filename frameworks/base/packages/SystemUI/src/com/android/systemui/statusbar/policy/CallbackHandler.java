 ...
 */
public class CallbackHandler extends CallbackHandlerBase
        implements EmergencyListener, SignalCallback{
    ...
    protected ArrayList<SignalCallback> getSignalCallbacks () {
