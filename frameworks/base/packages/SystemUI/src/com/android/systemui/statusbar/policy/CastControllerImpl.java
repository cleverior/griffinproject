...
public class CastControllerImpl implements CastController {
    ...
    public void setDiscovering(boolean request) {
        synchronized (mDiscoveringLock) {
            if (mDiscovering == request || !isWifiDisplayOn()) return;
    ...
    public void stopCasting(CastDevice device) {
        ...
        if (isProjection) {
            ...
            //SPRD: Bug621072 Modify audio router selection process, take bt a2dpon state into consideration
            //mMediaRouter.getDefaultRoute().select();
            mMediaRouter.selectDefaultRouteStatic();
            //SPRD: Modify end
        }
    }
    ...
    private boolean isWifiDisplayOn() {
