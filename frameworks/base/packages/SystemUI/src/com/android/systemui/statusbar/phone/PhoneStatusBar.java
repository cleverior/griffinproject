...
/* SPRD: FEATRUE_VENDOR_SIGNAL_CLUSTER_VIEW */
import com.android.systemui.statusbar.SignalClusterViewBase;
/* @} */
...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    // SPRD: Bug 474763 support transition on low-ram device.   243
    ...
    private static final String FIRST_BOOT = "phone_first_boot";
    /* @} */
    /**
    ...
    // SPRD: modify by BUG 597455
    private boolean mIsPanelVisiable = false;
    ...
    public static boolean mSupportLockApp = SystemUILockAppUtils.getInstance().isSupportLockApp();
    /* @} */
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        /* SPRD: FEATURE_SHOW_CARRIER_LABEL_IN_PANEL {@ */
        mCarrierLabel = (LinearLayout) mStatusBarWindow.findViewById(
    ...
    private void inflateSignalClusters() {
        /**
         * SPRD:signal_cluster_view.xml has been overlay and used SignalClusterViewEx as the layout
         * SignalClusterViewEx and SignalClusterView extends SignalClusterViewBase
         */
        SignalClusterViewBase signalClusterView = reinflateSignalCluster(mStatusBarView);
        mIconController.setSignalCluster(signalClusterView);
        reinflateSignalCluster(mKeyguardStatusBar);
    }

    private SignalClusterViewBase reinflateSignalCluster(View view) {
        SignalClusterViewBase signalCluster =
                (SignalClusterViewBase) view.findViewById(R.id.signal_cluster);
        if (signalCluster != null) {
            ...
            if (parent instanceof ViewGroup) {
                ...
                SignalClusterViewBase newCluster = (SignalClusterViewBase) LayoutInflater.from(mContext)
    ...
    protected void initSignalCluster(View containerView) {
        ...
        */
        SignalClusterViewBase signalCluster =
                (SignalClusterViewBase) containerView.findViewById(R.id.signal_cluster);
        if (signalCluster != null) {
    ...
    private void prepareNavigationBarView() {
        ...
        /* SPRD: Bug 505116 init assist manager whether system has navigation bar or not @{ */
        //mAssistManager.onConfigurationChanged();
        /* @} */
    }
    ...
    private void updateEmptyShadeView() {
        boolean showEmptyShade =
                mState != StatusBarState.KEYGUARD &&
                        /*SPRD: 632276 check visible of "No Notification" @{ */
    ...
    public void updateMediaMetaData(boolean metaDataChanged, boolean allowEnterAnimation) {
        ...
        if (ENABLE_LOCKSCREEN_WALLPAPER && artworkDrawable == null) {
            ...
            int firtBoot = Settings.System.getInt(mContext.getContentResolver(), FIRST_BOOT, 1);
            if(lockWallpaper == null && firtBoot == 1)
            {
                try{
                    ...
                    if (lockWallpaper.compress(Bitmap.CompressFormat.PNG, 100, tmpOut)) {
                        byte[] outByteArray = tmpOut.toByteArray();
                        mWallpaperManager.setStream(new ByteArrayInputStream(outByteArray), null, true, WallpaperManager.FLAG_LOCK);
                    }
                } catch (IOException e) {
                    Log.v(TAG, "IOException");
                }
                Settings.System.putInt(mContext.getContentResolver(), FIRST_BOOT, 0);
            }
            /* @} */
    ...
    public void setPanelExpanded(boolean isExpanded) {
        ...
        if(mSupportDynamicBar){
            if(mNavigationBarView != null && mNavigationBarView.getPullSwitchButton() != null) {
                if(isExpanded) {
                    mNavigationBarView.getPullSwitchButton().setImageResource(R.drawable.ic_sysbar_pull_up);
                } else {
                    mNavigationBarView.getPullSwitchButton().setImageResource(R.drawable.ic_sysbar_pull_down);
                }
            }
        }
        /* @} */
    ...
    public void destroy() {
        ...
        final SignalClusterViewBase signalCluster =
                (SignalClusterViewBase) mStatusBarView.findViewById(R.id.signal_cluster);
        final SignalClusterViewBase signalClusterKeyguard =
                (SignalClusterViewBase) mKeyguardStatusBar.findViewById(R.id.signal_cluster);
        final SignalClusterViewBase signalClusterQs =
                (SignalClusterViewBase) mHeader.findViewById(R.id.signal_cluster);
    ...
    protected void showRecents(boolean triggeredFromAltTab, boolean fromHome) {
        ...
        mSystemUiVisibility |= View.RECENT_APPS_VISIBLE;
        notifyUiVisibilityChanged(mSystemUiVisibility);
        super.showRecents(triggeredFromAltTab,fromHome);
    }
    ...
    protected void toggleRecents() {
        /* SPRD: add for bug 604055,awake the dreams after toggling the recents. @{ */
        awakenDreams();
        /* @} */
    ...
    protected void updateCarrierLabelVisibility() {
        if (mCarrierLabel.getTag() == null) return;
        // SPRD: modify by BUG 597455
        final boolean makeVisible = mIsPanelVisiable && mState != StatusBarState.KEYGUARD;
