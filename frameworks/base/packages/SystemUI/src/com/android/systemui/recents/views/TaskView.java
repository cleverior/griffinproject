...
public class TaskView extends FixedSizeFrameLayout implements Task.TaskCallbacks,
    ...
    /* @} */
    /* SPRD: Bug 594996 color of lock recent apps @{ */
    ...
    public TaskView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mLightFullscreenIcon = context.getDrawable(R.drawable.zzz_sprd_lock_recent_item);
        mDarkFullscreenIcon = context.getDrawable(R.drawable.zzz_sprd_lock_recent_item_dark);
    }
    ...
    public void onTaskBound(Task t, boolean touchExplorationEnabled, int displayOrientation,
        ...
        if(PhoneStatusBar.mSupportLockApp) {
            if (t.isLocked) {
                ...
                mLockIconView.setImageDrawable(t.useLightOnPrimaryColor ? mLightFullscreenIcon:mDarkFullscreenIcon );
            } else {
    ...
    public void onTaskDataLoaded(Task task, ActivityManager.TaskThumbnailInfo thumbnailInfo) {
        ...
        if(PhoneStatusBar.mSupportLockApp) {
            ...
            if (getTask().isLocked) {
                mLockIconView.setVisibility(VISIBLE);
                mLockIconView.setImageDrawable(task.useLightOnPrimaryColor ? mLightFullscreenIcon:mDarkFullscreenIcon );
            } else {
                mLockIconView.setVisibility(INVISIBLE);
            }
        }
    ...
    public void onLockIcon() {
        ...
        if (mTask.isLocked == false) {
            ...
            mLockIconView.setImageDrawable(mTask.useLightOnPrimaryColor ? mLightFullscreenIcon:mDarkFullscreenIcon );
            /*SPRD:bugfix 596961 @{*/
