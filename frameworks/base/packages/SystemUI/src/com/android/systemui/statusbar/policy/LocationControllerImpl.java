...
public class LocationControllerImpl extends BroadcastReceiver implements LocationController {
    ...
    //NOTE: Bug #599369 remove gps function if device no gps chip BEG -->
    private static final boolean GPS_DISABLED = SystemProperties.get("persist.sys.gps").equals(
            "disabled");
    //<-- remove gps function if device no gps chip END
