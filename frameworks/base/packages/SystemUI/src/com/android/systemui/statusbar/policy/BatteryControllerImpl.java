...
public class BatteryControllerImpl extends BroadcastReceiver implements BatteryController {
    ...
    private void registerReceiver() {
        ...
        filter.addAction("com.sprd.battery.percentage");
    ...
    public void addStateChangedCallback(BatteryController.BatteryStateChangeCallback cb) {
        /*SPRD bug 621314:mChangeCallbacks maybe cause IndexOutOfBoundsException while syn work.{@*/
    ...
    protected void fireBatteryLevelChanged() {
        ...
        synchronized (mChangeCallbacks) {
            ...
            for (int i = 0; i < N; i++) {
                //SPRD bug 611034 NullPointerException{@
                if(mChangeCallbacks.get(i) != null){
