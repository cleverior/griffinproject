...
public class UserSwitcherController {
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (ACTION_REMOVE_GUEST.equals(intent.getAction())) {
                ...
                if(mOnUserSwitchedListener != null){
                    mOnUserSwitchedListener.OnUserSwitched(currentId);
                }
                /*@}*/
    ...
    public OnUserSwitchedListener mOnUserSwitchedListener = null;

    public void setOnUserSwitchedListener(OnUserSwitchedListener listener){
        mOnUserSwitchedListener = listener;
    }
    /*@}*/
}
