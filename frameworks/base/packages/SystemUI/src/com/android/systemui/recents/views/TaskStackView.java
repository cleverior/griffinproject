...
public class TaskStackView extends FrameLayout implements TaskStack.TaskStackCallbacks,
   ...
   public void updateLayoutAlgorithm(boolean boundScrollToNewMinMax) {
       ...
       //SPRD bug 612251:Maybe throw NullPointerException {@
	   try{
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        /* SPRD: bug590659, catch IllegalArgumentException in MotionEvent @{ */
        try {
    ...
    public void onStackTasksRemoved(TaskStack stack) {
        ...
        for (int i = taskViews.size() - 1; i >= 0; i--) {
            ...
            boolean isLocked = taskViews.get(i).getTask().isLocked;
            if(isLocked){
                continue;
                }
            //}
