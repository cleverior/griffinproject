...
import com.android.systemui.statusbar.policy.UserSwitcherController.OnUserSwitchedListener;
...
public class MultiUserSwitch extends FrameLayout implements View.OnClickListener {
    ...
    /*SPRD bug 615794:Color inversion not work after change user{@*/
    ...
    public MultiUserSwitch(Context context, AttributeSet attrs) {
        ...
        /*SPRD bug 615794:Color inversion not work after change user{@*/
        mMyOnUserSwitchedListener = new MyOnUserSwitchedListener();
        /*@}*/
    }
    ...
    public void setUserSwitcherController(UserSwitcherController userSwitcherController) {
        ...
        if(mUserSwitcherController != null){
            mUserSwitcherController.setOnUserSwitchedListener(mMyOnUserSwitchedListener);
        }
        /*@}*/
    }
    ...
    /*SPRD bug 615794:Color inversion not work after change user{@*/
    private MyOnUserSwitchedListener mMyOnUserSwitchedListener = null;

    class MyOnUserSwitchedListener implements OnUserSwitchedListener{

        @Override
        public void OnUserSwitched(int currentUserId) {
            // TODO Auto-generated method stub
            if(mQsPanel != null){
                mQsPanel.onUserSwitched(currentUserId);
            }
        }
    }
    /*@}*/
