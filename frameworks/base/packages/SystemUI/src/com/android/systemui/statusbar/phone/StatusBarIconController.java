...
public class StatusBarIconController extends StatusBarIconList implements Tunable {
    ...
    private SignalClusterViewBase mSignalCluster;
    ...
    /*SPRD bug 621938 :BatteryLevel applyIconTint{@*/
    private TextView mBatteryLevel = null;
    /*@}*/
    ...
    public StatusBarIconController(Context context, View statusBar, View keyguardStatusBar,
        ...
        mSignalCluster = (SignalClusterViewBase) statusBar.findViewById(R.id.signal_cluster);
        ...
        /*SPRD bug 621938 :BatteryLevel applyIconTint{@*/
        mBatteryLevel = (TextView) statusBar.findViewById(R.id.battery_level_sprd);
        /*@}*/

        TunerService.get(mContext).addTunable(this, ICON_BLACKLIST);
    }

    public void setSignalCluster(SignalClusterViewBase signalCluster) {
    ...
    public static ArraySet<String> getIconBlacklist(String blackListStr) {
        ...
        if (blackListStr == null) {
            /*SPRD bug 623990:Set headset to default{@*/
