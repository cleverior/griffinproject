...
public class SplitClockView extends LinearLayout {
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_TIME_CHANGED.equals(action)
                ...
                updatePatterns();
                /*SPRD bug 617496:Clock and ampm text size not change after front size change{@*/
    ...
    private void updateTextSize() {
        int mClockCollapsedSize = getResources().getDimensionPixelSize(R.dimen.qs_time_collapsed_size);
        mTimeView.setTextSize(TypedValue.COMPLEX_UNIT_PX, mClockCollapsedSize);
        mAmPmView.setTextSize(TypedValue.COMPLEX_UNIT_PX, mClockCollapsedSize);
    }
    /*@}*/
}
