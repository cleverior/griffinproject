...
import com.android.server.power.AbsPowerGuruService;
import com.android.server.power.PowerGuruServiceFactory;
...
public final class SystemServer {
    ...
    private void startOtherServices() {
        ...
        //SPRD: Bug#570832 Add for LTE/SoftAp coexisting BEG-->
        WcnManagerService wcnManager = null;
        //<-- Add for LTE/SoftAp coexisting END

        //PowerGuruService powerguru
        ...
        boolean isRestartMinFw = SystemProperties.get("vold.decrypt").equals("trigger_restart_min_framework");
	...
	try {
        ...
        if (mFactoryTestMode != FactoryTest.FACTORY_TEST_LOW_LEVEL) {
            ...
            if (!disableNonCoreServices) {
                ...
                if (mPackageManager.hasSystemFeature(PackageManager.FEATURE_FINGERPRINT) && !isRestartMinFw) {
                    traceBeginAndSlog("FingerprintService");
                    try {
        ...
        //SPRD: Bug#570832 Add for LTE/SoftAp coexisting BEG-->
        if (SystemProperties.get("ro.softaplte.coexist","true").equals("true")) {
            //Create WcnManager
            try {
