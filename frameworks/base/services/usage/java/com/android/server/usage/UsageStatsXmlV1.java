...
final class UsageStatsXmlV1 {
    ...
    //joe
    private static final String TOTAL_LAUNCH_COUNT_ATTR = "launchCount";
    //joe
    ...
    private static void loadUsageStats(XmlPullParser parser, IntervalStats statsOut)
        ...
        //joe
        stats.mLaunchCount = XmlUtils.readIntAttribute(parser, TOTAL_LAUNCH_COUNT_ATTR);
        //joe
    }
    ...
    private static void writeUsageStats(XmlSerializer xml, final IntervalStats stats,
        ...
        //joe
        XmlUtils.writeIntAttribute(xml, TOTAL_LAUNCH_COUNT_ATTR, usageStats.mLaunchCount);
        //joe
