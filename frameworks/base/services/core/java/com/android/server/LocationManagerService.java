...
public class LocationManagerService extends ILocationManager.Stub {
    ...
    private void loadProvidersLocked() {
        ...
        //NOTE: Bug #474459 Support the cutting function of WCN(WLAN,BT,GPS) BEG -->
        if (GnssLocationProvider.isSupported() && !WCN_DISABLED) {
        //<-- Support the cutting function of WCN(WLAN,BT,GPS) END
    ...
    public void setAgpsServer(String provider, int type, String hostname, int port) {
        GnssLocationProvider p = (GnssLocationProvider) mProvidersByName.get(provider);
        if (p == null) {
    ...
    // SPRD: Bug#594231 Open Key debug log BEG -->
