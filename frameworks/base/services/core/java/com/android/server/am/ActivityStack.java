...
final class ActivityStack {
    ...
    private static boolean DEBUG_ARRAYLIST = SystemProperties.getBoolean("persist.debug.am.arraylist", false);

    /**
     * The back history of all previous (and possibly still
     * running) activities.  It contains #TaskRecord objects.
     */
    private final ArrayList<TaskRecord> mTaskHistory = DEBUG_ARRAYLIST ? new DebugArrayList<>() : new ArrayList<>();
    ...
    private void completePauseLocked(boolean resumeNext) {
        ...
        if (prev != null) {
            ...
            if(prev != null) prev.stopFreezingScreenLocked(true /*force*/);
            mPausingActivity = null;
        }
    ...
    final TaskRecord finishTopRunningActivityLocked(ProcessRecord app, String reason) {
        ...
        if (activityNdx >= 0) {
            // SPRD: convenient for IndexOutOfBoundsException error check.
    ...
    final ActivityRecord finishCurrentActivityLocked(ActivityRecord r, int mode, boolean oomAdj) {
        ...
        final boolean finishingActivityInNonFocusedStack
                = r.task != null && r.task.stack != mStackSupervisor.getFocusedStack()
