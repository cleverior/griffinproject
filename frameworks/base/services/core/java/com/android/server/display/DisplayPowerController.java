...
final class DisplayPowerController implements AutomaticBrightnessController.Callbacks {
    ...
    private void initialize() {
        ...
        PMSFactory.getInstance().createExtraDisplayPowerController(mContext).initButtonLight();
    ...
    private void updatePowerState() {
        ...
        switch (mPowerRequest.policy) {
            case DisplayPowerRequest.POLICY_OFF:
                ...
                // SPRD:disable screen off animation
    ...
    private void handleProximitySensorEvent(long time, boolean positive) {
        if (mProximitySensorEnabled) {
            ...
            mHandler.removeMessages(MSG_PROXIMITY_SENSOR_DEBOUNCED);
            if (positive) {
                PMSFactory.getInstance().createExtraDisplayPowerController(mContext).scheduleButtonTimeout(SystemClock.uptimeMillis());
