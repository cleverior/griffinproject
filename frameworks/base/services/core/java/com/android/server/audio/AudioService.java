...
public class AudioService extends IAudioService.Stub {
   ...
   /** Maximum volume index values for audio streams */
    ...
    private final int[] STREAM_VOLUME_ALIAS_VOICE = new int[] {
        ...
        /** SPRD:bug485754 split notification and ring alias. @{ */
    ...
    private void setRingerMode(int ringerMode, String caller, boolean external) {
        ...
        /* SPRD: bug607480, judge ringerMode to set mIsCtsMode @{ */
        ...
        synchronized (mSafeMediaVolumeState) {
            ...
            if ((mMcc != mcc) || ((mMcc == 0) && force)) {
                ...
                if (safeMediaVolumeEnabled && !safeMediaVolumeBypass) {
                    ...
                    // it to "active".
                    if (mSafeMediaVolumeState != SAFE_MEDIA_VOLUME_INACTIVE) {
                        /** SPRD: bug590326, SafetyWarningDialog doesn't show after phone is reboot. @{ */
                        /*
                        if (mMusicActiveMs == 0) {
    ...
    private int checkForRingerModeChange(int oldIndex, int direction, int step, boolean isMuted,
        ...
        case RINGER_MODE_VIBRATE:
            ...
            if ((direction == AudioManager.ADJUST_LOWER)) {
                ...
                Settings.System.putInt(mContentResolver, RINGER_MODE_CHANGED_VTON_FOR_NO_AUDIOPROFILE, 1);
                ringerMode = RINGER_MODE_NORMAL;
            }
            result &= ~FLAG_ADJUST_VOLUME;
            break;
        ...
        case AudioSystem.PLATFORM_VOICE:
            if (isInCommunication()) {
                ...
                if (isAfMusicActiveRecently(StreamOverride.sDelayMs)) {
                    ...
                    /** SPRD: bug590450, Notification route change @{ */
    ...
    private void broadcastRingerMode(String action, int ringerMode) {
        ...
        broadcast.addFlags(Intent.FLAG_RECEIVER_REGISTERED_ONLY_BEFORE_BOOT
                | Intent.FLAG_RECEIVER_REPLACE_PENDING);
        /* SPRD: bug607480, add cts test information to broadcast messages @{ */
        if (mIsCtsMode) {
    ...
    /**
     * SPRD: bug607480, define a variable to indicate whether cts test mode
     * @{
     */
