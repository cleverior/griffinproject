...
class WindowStateAnimator {
    ...
    void finishExit() {
        ...
        if (mWin.mReplacingRemoveRequested) {
            Slog.i(TAG, "mReplacingRemoveRequested finishExit mWin=" + mWin);
            return;
        }
    ...
    void prepareSurfaceLocked(final boolean recoveringMemory) {
        ...
        } else if (w.mForceHideSurface && !w.isInMultiWindowMode() && !w.isAnimatingLw()) {
            Slog.i(TAG, "forceHideSurface for Video");
            hide("forceHideSurface");
    ...
    private boolean showSurfaceRobustlyLocked() {
        ...
        /* SPRD:Hide Surface feature Bug475515 @{ */
        if(mSurfaceController == null) return false;
        /* @} */
