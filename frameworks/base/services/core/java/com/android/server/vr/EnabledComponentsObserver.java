...
public class EnabledComponentsObserver implements SettingChangeListener {
    ...
    public void rebuildAll() {
        ...
        mRequestRebuildAll = false;
        Slog.d(TAG, "rebuildAll() user = " + ActivityManager.getCurrentUser());
        sendSettingChanged();
    }

    private boolean mRequestRebuildAll;
    public void requestRebuildAll(boolean value) {
        mRequestRebuildAll = value;
    }
