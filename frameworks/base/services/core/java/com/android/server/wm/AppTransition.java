...
public class AppTransition implements Dump {
    ...
    private static final long APP_TRANSITION_TIMEOUT_MS_MONKEY = 2000;
    ...
    boolean prepareAppTransitionLocked(int transit, boolean alwaysKeepCurrent) {
        ...
        if (isTransitionSet()) {
            ...
            mService.mH.sendEmptyMessageDelayed(H.APP_TRANSITION_TIMEOUT,
                        mService.mIsUserAMonkey ? APP_TRANSITION_TIMEOUT_MS_MONKEY : APP_TRANSITION_TIMEOUT_MS);
        }
        return prepared;
    }
