...
public class DelayedDiskWrite {
    ...
    private AtomicInteger mWriteSequence = new AtomicInteger(0);
    ...
    public void write(final String filePath, final Writer w, final boolean open) {
        ...
        synchronized (this) {
            if (mWriteSequence.incrementAndGet() == 1) {
        ...
        try {
            ...
            loge("Fail to run write thread:" + e);
        }
    }
    ...
    private void doWrite(String filePath, Writer w, boolean open) {
        ...
        try {
            ...
            synchronized (this) {
                if (mWriteSequence.decrementAndGet() == 0) {
