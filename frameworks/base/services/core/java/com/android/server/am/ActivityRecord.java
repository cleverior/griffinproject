...
final class ActivityRecord {
    ...
    boolean supportThumbnail;// modify for Bug#618149
    ...
    ActivityRecord(ActivityManagerService _service, ProcessRecord _caller,
        ...
        supportThumbnail = service.pkgSupportRecentThumbnail(packageName);// modify for Bug#618149
    }
    ...
    void windowsDrawnLocked() {
        ...
        if (displayStartTime != 0) {
            ...
            if(task.mFullscreen == true){
                if (supportThumbnail && intent.hasCategory(Intent.CATEGORY_LAUNCHER)
                    && (service.mConfiguration.orientation == Configuration.ORIENTATION_PORTRAIT)){
                    service.scheduleUpdateCurrentTaskThumbnail(this);
                }
            }
