...
final class WindowState implements WindowManagerPolicy.WindowState {
    ...
    final WMSHelper mWMSHelper = WMSFactory.getHelperInstance();
    ...
    private boolean shouldSaveSurface() {
        ...
        */
        if (mWMSHelper.forceNotSaveSurface(this)) {
            return false;
        }
        /* @} */
    ...
    void destroyOrSaveSurface() {
        ...
        /* SPRD: When monkey, do not save surface */
        if (mSurfaceSaved && !mService.mIsUserAMonkey) {
    ...
    boolean mForceHideSurface = false;
    /* SPRD:hide Surface feature Bug 475515@{ */
    @Override
    public void requestHideSurface(boolean hide) {
        if (mForceHideSurface == hide) {
            return;
        }
        mForceHideSurface = hide;
