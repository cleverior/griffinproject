...
final class Notifier {
    ...
    public void onWakeLockAcquired(int flags, String tag, String packageName,
        ...
        updateWakeLockStatusLocked(OPT_ADD, ownerUid, flags, workSource);
        //Bug 624590 end
    ...
    public void onWakeLockChanging(int flags, String tag, String packageName,
        ...
        if (workSource != null && newWorkSource != null
            ...
            //Bug 624590 send wakelock info to AMS start
            updateWakeLockStatusLockedChanging(flags, workSource, newWorkSource);
            //Bug 624590 end
            if (DEBUG) {
    ...
    public void onWakeLockReleased(int flags, String tag, String packageName,
        ...
        //Bug 624590 send wakelock info to AMS start
        updateWakeLockStatusLocked(OPT_RELEASE, ownerUid, flags, workSource);
        //Bug 624590 end
        final int monitorType = getBatteryStatsWakeLockMonitorType(flags);
        if (monitorType >= 0) {
            try {
    ...
    int OPT_ADD = 0;
    int OPT_RELEASE = 1;
    private void updateWakeLockStatusLocked(int opt, int lockUid, int flags, WorkSource workSource) {
        try {
            if(mAms == null){
            ...
            if((flags & PowerManager.PARTIAL_WAKE_LOCK) != 0) {
                ...
                mAms.updateWakeLockStatus(opt, uids);
            }
        } catch (Exception e) {}
    }
    private void updateWakeLockStatusLockedChanging(int flags, WorkSource from, WorkSource to) {
        try {
            if(mAms == null){
                mAms = (ActivityManagerService)ActivityManagerNative.getDefault();
            }
            if((flags & PowerManager.PARTIAL_WAKE_LOCK) != 0) {
                ...
                mAms.updateWakeLockStatusChanging(fromUids, toUids);
            }
        } catch (Exception e) {}
    }
    //Bug 624590 end
