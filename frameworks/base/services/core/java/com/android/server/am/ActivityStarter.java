...
class ActivityStarter {
    ...
    final int startActivityLocked(IApplicationThread caller, Intent intent, Intent ephemeralIntent,
        ...
        if (intent.getComponent() != null) basePackage = intent.getComponent().getPackageName();
        if(!mService.addListAndJudgeAllowLocked(basePackage, callingPackage, "start-activity")){
        ...
        if ((launchFlags & Intent.FLAG_ACTIVITY_FORWARD_RESULT) != 0 && sourceRecord != null) {
            ...
            if (requestCode >= 0) {
                ...
                Slog.d(TAG,"startActivityLocked return START_FORWARD_AND_REQUEST_CONFLICT");
        ...
        if (err != START_SUCCESS) {
            ...
            ActivityOptions.abort(options);
            Slog.d(TAG,"startActivityLocked abort return " + err);
            return err;
        }
        ...
        if (abort) {
            ...
            ActivityOptions.abort(options);
            Slog.d(TAG,"startActivityLocked abort return START_SUCCESS");
        ...
        if((!r.isHomeActivity())&&(!r.isRecentsActivity())){
            ...
            mPowerManagerInternal.powerHint(PowerManagerInternal.POWER_HINT_INTERACTION,
                    PowerManagerInternal.POWER_HINT_FLAG_LAUNCH);
            /* Bug#601097  Add PowerHint interaction subtype for different performance scenes > */
        }
