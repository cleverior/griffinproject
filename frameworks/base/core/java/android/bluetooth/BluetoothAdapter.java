...
public final class BluetoothAdapter {
    ...
    public boolean disableBLE() {
        try {
            if (mManagerService.isBleFeatureSupport() == false) {
                Log.w(TAG, "Bluetooth ble is not support, disableBLE invalid!");
                return false;
            }
        } catch (RemoteException e) {
            Log.e(TAG, "", e);
    ...
    public boolean enableBLE() {
        try {
            if (mManagerService.isBleFeatureSupport() == false) {
                Log.w(TAG, "Bluetooth ble is not support, enableBLE invalid!");
                return false;
            }
        } catch (RemoteException e) {
            Log.e(TAG, "", e);
