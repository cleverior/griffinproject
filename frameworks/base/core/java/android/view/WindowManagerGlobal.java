...
public final class WindowManagerGlobal {
    ...
    public void addView(View view, ViewGroup.LayoutParams params,
        ...
        synchronized (mLock) {
            ...
            root = VRIFactory.getNewObject(view.getContext(), display);
    ...
    public void updateViewLayout(View view, ViewGroup.LayoutParams params) {
        ...
        synchronized (mLock) {
            ...
            /* SPRD: Bug  614458 - monkey test, view is not attached. @{ */
            if(index < 0) {
                Log.w(TAG,"updateLayout view's index: "+index+" , this view's window has already gone");
                return;
            }
            /* @} */
    ...
    public void removeView(View view, boolean immediate) {
        ...
        synchronized (mLock) {
            ...
            /* SPRD: Bug  614458 - monkey test, view is not attached. @{ */
            if(index < 0) {
                Log.w(TAG,"remove view's index: "+index+" , this view's window has already gone");
                return;
            }
            /* @} */
    ...
    private int findViewLocked(View view, boolean required) {
        ...
        if (required && index < 0 ) {
            if(ActivityManager.isUserAMonkey()) {
                Log.w(TAG,"may be monkey error: Window has leaked! view is: "+view+", index is: "+index);
            } else {
