...
public class View implements Drawable.Callback, KeyEvent.Callback,
    ...
    */
    ...
    /**
     * Dispatch {@link #onFinishTemporaryDetach()} to this View and its direct
     * children if this is a container View.
     *
     * SPRD:root cause is that InputMethodManager#focusIn(View) is now always
     * ignored as long as the View is temporarily detached, under an assumption
     * that IMM#focusIn(View) will be called back again with a View that is not
     * temporarily detached when everything is stable. Hence the fix is to do so
     * by hooking up View#dispatchFinishTemporaryDetach() to call
     * IMM#focusIn(View) again when the View is actually focused in the final
     * state.
     */
    @CallSuper
