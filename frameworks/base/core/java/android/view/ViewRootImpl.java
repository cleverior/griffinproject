...
public class ViewRootImpl extends AbsViewRootImpl implements ViewParent,
    ...
    private static final String PROPERTY_PROFILE_UIAUTOMATOR = "persist.sys.uiautomator";
    ...
    private void performTraversals() {
        ...
        if (mFirst || windowShouldResize || insetsChanged ||
            ...
            /* SPRD: when surface=null and visible, give another chance to relayout window  @{ */
            ...
            if (!(mFirst || windowShouldResize || insetsChanged ||
                ...
                Log.i(TAG, "give another chance to relayoutWindow " + mWindowAttributes.getTitle());
            }
            /* }@ */
        ...
        if(!mSurface.isValid() && viewVisibility == View.VISIBLE) {
            Slog.e(TAG, "mTmpRelayoutNeeded = true, win = " + mWindowAttributes.getTitle());
        ...
        public void handleMessage(Message msg) {
            ...
            case MSG_WINDOW_FOCUS_CHANGED: {
                if (mAdded) {
                    ...
                    /* SPRD: modify 20161213 Spreadtrum of 615080 */
                    boolean mUiAutomator = SystemProperties.getBoolean(PROPERTY_PROFILE_UIAUTOMATOR, false);
                    if(mUiAutomator) {
                        Log.d(TAG,"For UiAutomator Current window is focused: "+hasWindowFocus+", AM is Enable: "+(mAccessibilityManager.isEnabled())+", mView+"+mView);
