...
public class Camera {
    ...
    public static void getCameraInfo(int cameraId, CameraInfo cameraInfo) {
         ...
         *
         */
        SprdCamera.checkCameraId(cameraId);
        ...
        try {
            if (audioService.isCameraSoundForced()) {
                ...
                // decide.
                /*
                 * SPRD: Fix bug 474665 add control for shutter sound for api1 in soundforced @{
                 * Original Code
                 *
     ...
     * @hide
     */
    protected int cameraInitNormal(int cameraId) {
    ...
    Camera(int cameraId) {
         ...
         */
        int err = SprdCamera.checkError(this, cameraId);
        /* @}*/
        if (checkInitErrors(err)) {
            if (err == -EACCES) {
                throw new RuntimeException("Fail to connect to camera service");
...
//        }
     ...
     * @hide
     */
    protected native final boolean _enableShutterSound(boolean enabled);
