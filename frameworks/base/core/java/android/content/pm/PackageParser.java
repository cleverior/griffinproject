...
public class PackageParser {
    ...
    protected static Certificate[][] loadCertificates(StrictJarFile jarFile, ZipEntry entry)
    ...
    private static void collectCertificates(Package pkg, File apkFile, int parseFlags)
        ...
        try {
            ...
            if ((parseFlags & PARSE_IS_SYSTEM_DIR) != 0) {
                ...
                PackageParserExUtils.collectNonSystemAppCertificates(pkg, toVerify, jarFile, apkFile);
            }
    ...
    protected static Signature[] convertToSignatures(Certificate[][] certs)
