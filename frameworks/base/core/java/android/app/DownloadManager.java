    ...
    public boolean rename(Context context, long id, String displayName) {
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                ...
                if (mAccessFilename) {
                    filename = cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_LOCAL_FILENAME));
                }
            }
        } finally {
            if (cursor != null) {
        ...
        File parent = null;
        if (filename != null) {
            parent = new File(filename).getParentFile();
        }
        if (parent == null) {
        ...
        Log.d("DownloadManager", "rename, filename = " + filename);
        Log.d("DownloadManager", "rename, parent = " + parent);
