...
import android.os.AbsPowerManager;
...
import com.android.internal.telephony.FrameworkFactory;

import java.util.HashMap;

import android.app.AbsPowerGuru;
import android.app.PowerGuruFactory;
...
final class SystemServiceRegistry {
    ...
    static {
        ...
        registerService("power_ex", AbsPowerManager.class,
                new CachedServiceFetcher<AbsPowerManager>() {
                    @Override
                    public AbsPowerManager createService(ContextImpl ctx) {
                        return PMFactory.getInstance().createExtraPowerManager(ctx.getOuterContext());
                    }});
        ...
        registerService("phone_ex", AbsTelephonyManager.class,
                new CachedServiceFetcher<AbsTelephonyManager>() {
            @Override
            public AbsTelephonyManager createService(ContextImpl ctx) {
                return FrameworkFactory.getInstance().createExtraTelephonyManager(ctx.getOuterContext());
            }});
        /* @} */
        ...
        /* SPRD: Initialize extended service. @{ */
        registerService("carrier_config_ex", AbsCarrierConfigManager.class,
                new CachedServiceFetcher<AbsCarrierConfigManager>() {
            @Override
            public AbsCarrierConfigManager createService(ContextImpl ctx) {
                return FrameworkFactory.getInstance().createExtraCarrierConfigManager();
            }});
           /* @} */
