...
public class BlockedNumberContract {
    ...
    public static class SystemContract {
        ...
        public static BlockSuppressionStatus getBlockSuppressionStatus(Context context) {
            /* SPRD: modify for bug603883 @{ */
            final Bundle res = context.getContentResolver().call(
                    AUTHORITY_URI, METHOD_GET_BLOCK_SUPPRESSION_STATUS, null, null);
            if (res == null) {
                return new BlockSuppressionStatus(false, 0);
            }
            return new BlockSuppressionStatus(res.getBoolean(RES_IS_BLOCKING_SUPPRESSED,
                    false), res.getLong(RES_BLOCKING_SUPPRESSED_UNTIL_TIMESTAMP,
                    0));
            /* @} */
        }
