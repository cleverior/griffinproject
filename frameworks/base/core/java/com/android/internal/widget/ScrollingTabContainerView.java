...
public class ScrollingTabContainerView extends HorizontalScrollView
    ...
    public void setTabSelected(int position) {
        ...
        /*SPRD: modify 20160913 Spreadtrum of 595668 update the selected tab and refresh layout@{*/
        updateTab(position);
        /*@}*/
    }
    ...
    public void updateTab(int position) {
        /*
         * SPRD: SPRD: modify 20160928 Spreadtrum of 603757 add NPE check,
         * tabView's tabView maybe null! @{
         */
        if (mTabLayout != null) {
